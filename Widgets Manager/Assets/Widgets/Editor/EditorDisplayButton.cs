...
namespace eeGames.Widget
{
        ...
        public ActingType ActingType
        {
            ...
            set
            {
                if (value != m_actingTypePrevious)
                {
                    ...
                    if (m_actingType == eeGames.Widget.ActingType.Color)
                    {
    ...
    public class ActorVec3Editor : CommonActorElements
    {
        ...
        {
            GUI.color = Color.yellow;
            if (LoopType == eeGames.Widget.LoopType.StartOver && ActingType == eeGames.Widget.ActingType.Rotation)
        ...
        public override void Update()
        {
            ...
            if (ActingType == eeGames.Widget.ActingType.Color)
            {
                DrawColorActor();
            }
            else
